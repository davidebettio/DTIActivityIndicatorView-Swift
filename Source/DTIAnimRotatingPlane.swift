...
class DTIAnimRotatingPlane: DTIAnimProtocol {
    ...
    func startActivity() {
        ...
        anim.values = [
            NSValue(caTransform3D: self.transformPlane(perspective: 1.0/120.0, angle: 0.0, x: 0.0, y: 0.0, z: 0.0)),
            NSValue(caTransform3D: self.transformPlane(perspective: 1.0/120.0, angle: CGFloat(Double.pi), x: 0.0, y: 1.0, z: 0.0)),
            NSValue(caTransform3D: self.transformPlane(perspective: 1.0/120.0, angle: CGFloat(Double.pi), x: 0.0, y: 0.0, z: 1.0))
        ]
